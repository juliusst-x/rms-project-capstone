    ...
    def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
        ...
        for (x, y, w, h) in features:
            ...
            if confidence > 70 and not justscanned:
                ...
                mycursor.execute("select a.img_person, b.prs_name, b.prs_role "
                                 "  from img_dataset a "
...
@app.route('/')
def home():
    mycursor.execute("select prs_nbr, prs_name, prs_role, prs_active, prs_added from prs_mstr")
...
def fr_page():
    ...
    mycursor.execute("select a.accs_id, a.accs_prsn, b.prs_name, b.prs_role, a.accs_added "
                     "  from accs_hist a "
...
def loadData():
    ...
    mycursor.execute("select a.accs_id, a.accs_prsn, b.prs_name, b.prs_role, date_format(a.accs_added, '%H:%i:%s') "
                     "  from accs_hist a "
                     "  left join prs_mstr b on a.accs_prsn = b.prs_nbr "
                     " where a.accs_date = curdate() "
                     " order by 1 desc")
