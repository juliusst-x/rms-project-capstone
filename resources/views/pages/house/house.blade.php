		...
		<div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
			<div class="w-full overflow-x-auto">
				...
				<table class="w-full whitespace-no-wrap">
					<thead>
						<tr
							class="text-center font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800 justify-center">
					...
					<tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
						...
						<tr class="text-center text-gray-700 dark:text-gray-400">
							...
							<td class="px-4 py-3 flex items-center justify-center space-x-3">
								<a href="{{ route('house.edit', $data->identifiers) }}"
									class="bg-blue-600 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded">Edit</a>
								<button onclick="confirmDelete('{{ $data->identifiers }}')"
									class="bg-red-600 hover:bg-red-900 text-white font-bold py-2 px-4 rounded">Delete</button>
								<form id="delete-form-{{ $data->identifiers }}"
									action="{{ route('house.delete', $data->identifiers) }}" method="POST"
									style="display: none;">
									@csrf
									@method('DELETE')
								</form>
