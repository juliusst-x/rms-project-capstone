						...
						<tr class="text-gray-700 dark:text-gray-400 ">
							...
							<td class="px-4 py-3">
								<div class="flex items-center space-x-4 text-sm">
									<a href="{{ route('admin-concern-detail', $item->identifiers) }}"
									...
									<button onclick="confirmDelete('{{ $item->identifiers }}')"
										class="flex items-center justify-between text-sm font-medium leading-5 text-red-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
										aria-label="Delete">
									...
									<form id="delete-form-{{ $item->identifiers }}"
										action="{{ route('admin-concern-delete', $item->identifiers) }}" method="POST"
										style="display: none;">
										@csrf
										@method('delete')
									</form>
