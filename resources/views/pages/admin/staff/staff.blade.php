					...
					<tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
						...
						<tr class="text-gray-700 dark:text-gray-400">
							...
							<td class="px-4 py-3 text-sm">
								...
								<form action="{{ route('staff.delete', $staff->identifiers) }}" method="POST"
									class="inline-block">
									@csrf
									@method('DELETE')
									<button type="submit"
										class="bg-red-600 hover:bg-red-600 text-white font-bold py-2 px-4 rounded w-full sm:w-auto">Delete</button>
